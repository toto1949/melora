...
export const seedPackages: Package[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Three guided revision credits",
      "Recipient gift email delivery",
    ],
    revisionCredits: 3,
    includesVideo: false,
    includesWav: false,
...
export const seedReviews: Review[] = [
  {
    id: "rev-1",
    customerName: "Maya J. · Austin, TX",
    occasion: "Anniversary",
    rating: 5,
    body: "We turned our Sunday-market mornings into a song for our anniversary. He cried halfway through the first listen — in the best way. Felt personal, not generic.",
  ...
  {
    id: "rev-2",
    customerName: "Chris P. · Denver, CO",
    occasion: "Birthday",
    rating: 5,
    body: "Ordered for my sister in Colorado. Setup took maybe ten minutes and the private listening page looked gorgeous when we played it at her party.",
    isVerifiedPurchase: true,
    isDemo: true,
    isPublished: true,
    mediaUrl: null,
  ...
  {
    id: "rev-3",
    customerName: "Ashley R. · Nashville, TN",
    occasion: "Mother's Day",
    rating: 5,
    body: "Wrote about Mom's porch coffee and the way she always remembers everyone's birthdays. The lyrics landed so specifically it startled us.",
    isVerifiedPurchase: true,
    isDemo: true,
    isPublished: true,
    mediaUrl: null,
  ...
  {
    id: "rev-4",
    customerName: "Jordan Lee · Seattle, WA",
    occasion: "Wedding",
    rating: 4,
    body: "Used it for our first dance. One small lyric tweak and the revision came back fast. Guests asked who wrote it.",
    isVerifiedPurchase: true,
    isDemo: true,
    isPublished: true,
    mediaUrl: null,
  ...
  {
    id: "rev-5",
    customerName: "Sam T. · Chicago, IL",
    occasion: "Father's Day",
    rating: 5,
    body: "Dad never says much, but he asked for the lyrics printed. Steady Hands energy — quiet, proud, totally him.",
    isVerifiedPurchase: true,
    isDemo: true,
    isPublished: true,
    mediaUrl: null,
