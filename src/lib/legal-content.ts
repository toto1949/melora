...
export const LEGAL_CONTENT: Record<LegalLocale, Record<LegalDocumentKey, LegalDocument>> = {
  en: {
    ...
    privacy: {
      title: "Privacy Policy", updated: "Last updated September 11, 2026",
      ...
      sections: [
        { title: "1. What we collect", body: "We collect account details such as email and name; the order, recipient, story, and music preferences you submit; optional private uploads; payment totals and status from Stripe, but never your card number; and, after analytics consent, page and funnel events, campaign parameters (UTMs), and advertising click identifiers such as gclid, fbclid, and ttclid. We do not store raw IP addresses in analytics records." },
        ...
        { title: "4. Who we share data with", body: "We share only necessary data with service processors such as Supabase, Stripe, Vercel, Resend, and generation providers. With analytics consent, measurement events may also be sent to Google Analytics, Meta, and TikTok. Stories, lyrics, recipient details, and uploads are never sent to advertising analytics. We never sell personal data." },
  ...
  fr: {
    ...
    privacy: {
      title: "Politique de confidentialité", updated: "Dernière mise à jour : 11 septembre 2026",
      ...
      sections: [
        { title: "1. Données collectées", body: "Nous collectons les données de compte, les informations de commande, de destinataire, d'histoire et de musique, les fichiers privés facultatifs, le total et le statut de paiement transmis par Stripe (jamais le numéro de carte) et, après consentement, les pages et étapes consultées, les paramètres UTM et les identifiants publicitaires gclid, fbclid et ttclid. Les données analytiques ne contiennent pas d'adresse IP brute." },
        ...
        { title: "4. Destinataires", body: "Les données nécessaires sont partagées avec Supabase, Stripe, Vercel, Resend et les fournisseurs de génération. Avec votre consentement analytique, des événements de mesure peuvent aussi être envoyés à Google Analytics, Meta et TikTok. Les histoires, paroles, informations du destinataire et fichiers ne leur sont jamais envoyés. Nous ne vendons jamais vos données personnelles." },
  ...
  es: {
    ...
    privacy: {
      title: "Política de privacidad", updated: "Última actualización: 11 de septiembre de 2026",
      intro: "Tus canciones nacen de historias personales. Esta política explica qué recopilamos, por qué y qué opciones tienes.",
      sections: [
        { title: "1. Qué recopilamos", body: "Recopilamos datos de cuenta; datos del pedido, destinatario, historia y música; archivos privados opcionales; importes y estado del pago enviados por Stripe, nunca el número de tarjeta; y, con consentimiento, páginas y etapas visitadas, parámetros UTM e identificadores publicitarios gclid, fbclid y ttclid. Los registros analíticos no guardan direcciones IP sin procesar." },
        ...
        { title: "4. Con quién compartimos", body: "Compartimos solo lo necesario con Supabase, Stripe, Vercel, Resend y proveedores de generación. Con consentimiento analítico, también podemos enviar eventos de medición a Google Analytics, Meta y TikTok. Nunca les enviamos historias, letras, datos del destinatario ni archivos. Nunca vendemos datos personales." },
  ...
  ar: {
    ...
    privacy: {
      title: "سياسة الخصوصية", updated: "آخر تحديث: 11 سبتمبر 2026",
      ...
      sections: [
        { title: "1. ما نجمعه", body: "نجمع بيانات الحساب؛ ومعلومات الطلب والمُهدى إليه والقصة والموسيقى؛ والملفات الخاصة الاختيارية؛ وإجمالي الدفع وحالته من Stripe دون رقم بطاقتك؛ وبعد موافقتك على التحليلات نجمع الصفحات والمراحل المستخدمة ومعلمات UTM ومعرّفات النقر الإعلاني gclid وfbclid وttclid. لا نخزن عناوين IP الخام في سجلات التحليلات." },
        ...
        { title: "4. مشاركة البيانات", body: "نشارك الضروري فقط مع Supabase وStripe وVercel وResend ومزودي الإنشاء. وبموافقتك على التحليلات قد نرسل أحداث القياس إلى Google Analytics وMeta وTikTok. لا نرسل إليهم القصص أو الكلمات أو بيانات المُهدى إليه أو الملفات. لا نبيع بياناتك الشخصية." },
